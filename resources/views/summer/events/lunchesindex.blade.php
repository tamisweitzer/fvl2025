<x-layout>
    <x-wrapper-narrow class="mt-8 mb-8 mx-auto">
        <x-page-title>Lunchtime Concerts</x-page-title>
        <p class="-mt-4 mb-12 text-center">The complete list of lunchtime concerts happening around the Fox Valley this
            summer.</p>
