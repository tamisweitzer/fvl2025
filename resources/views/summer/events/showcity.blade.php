<x-layout>
    <x-wrapper-narrow class="mt-8 mb-8 mx-auto p-4">
        <x-page-title>{{ $events->first()->first()->city }}</x-page-title>
        <p class="-mt-4 mb-12 text-center">The complete list of live bands playing in
            {{ $events->first()->first()->city }}, WI this
            summer.</p>
