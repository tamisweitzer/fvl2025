<x-layout>
    <x-wrapper-narrow>
        ...
        @auth
            ...
            <form action="/cities/{id}/edit" method="post" class="mb-12" enctype="multipart/form-data">
                @csrf
                <x-form-group>
                ...
                <x-form-group>
                    ...
                    <x-inpu <p>Sorry, public access is not available at this time. </p>
                        <p>Please email Tami at <a href="mailto:foxvalleylive@gmail.com"
                                class="font-semibold underline underline-offset-2">foxvalleylive@gmail.com</a> to
                            be added to the site.</p>t-text-area name="excerpt" id="excerpt"
