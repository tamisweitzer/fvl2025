...
<body class="bg-slate-100 h-full">
    ...
    <main id="main" class="min-h-[calc(100vh-200px)]">
        <div class="max-w-2xl mx-auto p-4 mt-8 mb-8">
            ...
            <p class="mb-12">Coming soon! For more information, follow me on <a
                    href="https://www.facebook.com/foxvalleylive" class="underline underline-offset-2">Facebook</a>, or
                submit your email
                below.</p>
