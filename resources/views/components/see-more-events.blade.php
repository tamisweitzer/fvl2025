...
<h3 class="border-t mt-12 pt-8 text-center text-2xl ">Search live music in any of these categories</h3>
<div class="grid grid-cols-2 gap-4 mt-4 mb-12">
    <x-see-more-link href="/summer/events/lunchtime-concerts">
        <h3 class="text-sm text-center font-bold border-b border-b-transparent">Lunchtime Concerts</h3>
    ...
    <x-see-more-link href="/summer/events/fairs-fests">
        <h3 class="text-sm text-center font-bold border-b border-b-transparent">Fairs, Fests, and Outdoor Concerts</h3>
    ...
    <x-see-more-link href="/summer/events/national-bands">
        <h3 class="text-sm text-center font-bold border-b border-b-transparent">Bar and
            Restaurant Gigs</h3>
    ...
    <x-see-more-link href="/summer/events/national-bands">
        <h3 class="text-sm text-center font-bold border-b border-b-transparent">National Acts</h3>
